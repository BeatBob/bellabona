      ...
      <div className="mt-10 flex flex-col sm:mt-14">
        {items.map((item, i) => (
          <details
            ...
            {...(i === 0 ? { open: true } : {})}
          >
            <summary className="flex cursor-pointer list-none items-center justify-between gap-6 rounded text-left font-semibold text-brand-dark focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-green">
              <span className="text-base sm:text-lg">{item.question}</span>
              <span className="faq-icon flex size-6 shrink-0 items-center justify-center rounded-full text-brand-dark/70 transition-transform">
